$.getJSON("https://api-alquranid.herokuapp.com/surah", function(value){
    ...
    $.each(value.data, function(i,value){
         $('#list-surah').append('<div class="col-lg-2 col-md-3 col-6 mb-4"><div class="card"><div class="card-body"><h6><a onClick="sessionStorage.somekey = '+ value.nomor +'; console.log(sessionStorage.somekey);" data-fajax="false" href="ayat.html">'+ value.nomor +'. '+ value.nama +'</a></h6></div></div></div>');
     });
});
